...
public class TuTuViewModel extends AndroidViewModel {
    ...
    private class APIHelper {
         ...
         */
        void requestFeedUpdateViaAPI(boolean backgroundThread) {
            if (backgroundThread) {
    ...
    // reference to APIHelper (wrapper around REST client)
    ...
    public void requestFeedUpdate(boolean requestNewItems) {
        ...
        if (isOnline) {
            apiHelper.requestFeedUpdateViaAPI(false);
        } else {
            localStorageHelper.readCategoriesFromFile();
        }
    }
    ...
    public void requestDetailsUpdate() {
        if (isOnline) {
            apiHelper.requestDetailsViaAPI();
        } else {
    ...
    public void setNetworkStatus(boolean isOnline) {
        ...
        if (isOnline && offlineCategoriesInFeed) {
            apiHelper.requestFeedUpdateViaAPI(true);
        }
    }
